	...
	<div class="col-sm-3">
			...
			<div class="card">
				<div class="card-body main-center">
					...
					<div class="row">
						<div class="col-sm-12"><input type="submit" value="<spring:message code="Search" text="Search" />" style="margin-top: 15px;" class="btn btn-sm btn-success form-control"></div>
					</div>
				</div>
			</div>
			</form>
	...
	<div class="col-sm-9">
		<c:choose>
			<c:when test="${page.getContent().size() > 0}">
				...
				<div class="row">
					<div class="col-sm-1"><a class="btn btn-success btn-sm" href="${contextPath}/excel?reportName=<%=Constants.STOCK%>"><spring:message code="Export as Excel" text="Export as Excel" /></a></div>
					<c:choose>
